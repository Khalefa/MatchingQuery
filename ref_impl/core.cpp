...
typedef vector<Query> queries_v;
map<DocID,queries_v> m_queries;
queries_v queries;
...
ErrorCode MatchDocument_st(DocID doc_id, const char* doc_str)
{
	char cur_doc_str[MAX_DOC_LENGTH];
	strcpy(cur_doc_str, doc_str);
	queries_v c_queries= m_queries[doc_id];
	unsigned int i, n=c_queries.size();
...
queries_v c_q;
  ...
  m_queries[doc_id]=c_q;
  MatchDocument_st(doc_id, doc_str);
}
///////////////////////////////////////////////////////////////////////////////////////////////
